...
export function UtilityPricingPage({
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Cấu Hình Giá Dịch Vụ</h1>
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900">Tiền nước</h3>
                  <p className="text-sm text-gray-500">Tính theo số người</p>
                </div>
              </div>
            ...
            {!editingWater ? (
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-6 border border-blue-100">
                <p className="text-xs font-bold text-blue-600 uppercase tracking-wider mb-2">Giá hiện tại</p>
              ...
              /* Edit Mode */
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-6 border border-blue-100">
                <p className="text-xs font-bold text-blue-600 uppercase tracking-wider mb-3">Cập nhật giá</p>
                <div className="space-y-4">
                  <div>
                    <label className="text-sm text-gray-600 block mb-2">Giá mỗi người (VND)</label>
                    <input
                      type="number"
                      value={waterPrice}
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setWaterPrice(Number(e.target.value))}
                      className="w-full p-4 bg-white border-2 border-blue-200 rounded-xl text-2xl font-bold text-center"
                      autoFocus
                    />
                  </div>
                  <div className="flex gap-2">
                    <button
                      ...
                      disabled={saving}
                      className="flex-1 p-3 bg-white border border-gray-200 rounded-xl font-bold text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50"
                    >
                    ...
                    <button
                      ...
                      disabled={saving}
                      className="flex-1 p-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transition-colors disabled:opacity-50 flex items-center justify-center"
                    >
                      {saving ? (
                        <>Đang lưu...</>
                      ) : (
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900">Tiền điện</h3>
                  <p className="text-sm text-gray-500">Tính theo số kWh</p>
                </div>
              </div>
            ...
            {!editingElectricity ? (
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-6 border border-amber-100">
                <p className="text-xs font-bold text-amber-600 uppercase tracking-wider mb-2">Giá hiện tại</p>
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl font-black text-gray-900">
              ...
              /* Edit Mode */
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-6 border border-amber-100">
                <p className="text-xs font-bold text-amber-600 uppercase tracking-wider mb-3">Cập nhật giá</p>
                <div className="space-y-4">
                  <div>
                    <label className="text-sm text-gray-600 block mb-2">Giá mỗi kWh (VND)</label>
                    <input
                      type="number"
                      value={electricityPrice}
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setElectricityPrice(Number(e.target.value))}
                      className="w-full p-4 bg-white border-2 border-amber-200 rounded-xl text-2xl font-bold text-center"
                      autoFocus
                    />
                  </div>
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      disabled={saving}
                      className="flex-1 p-3 bg-amber-600 text-white rounded-xl font-bold hover:bg-amber-700 transition-colors disabled:opacity-50 flex items-center justify-center"
                    >
                      {saving ? (
                        <>Đang lưu...</>
                      ) : (
